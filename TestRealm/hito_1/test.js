...
console.group("TEST 9: countCartTotalAmount");
console.log("countCartTotalAmount of initial cart");
...
console.group("TEST 10: countCartTotalAmount");
console.log("countCartTotalAmount of result4");
